...
/**
 * The <tt>SeparateChainingHashST</tt> class represents a symbol table of
 ...
 * <tt>null</tt> is equivalent to deleting the key from the symbol table.
 * <p>
 * This implementation uses a separate chaining hash table. It requires that the
 * key type overrides the <tt>equals()</tt> and <tt>hashCode()</tt> methods. The
 ...
 * href="http://algs4.cs.princeton.edu/34hash">Section 3.4</a> of <i>Algorithms,
...
public class SeparateChainingHashST<Key, Value>
{
	...
	{
		final SeparateChainingHashST<Key, Value> temp = new SeparateChainingHashST<Key, Value>(
				chains);
		for (int i = 0; i < M; i++)
		{
			for (final Key key : st[i].keys())
