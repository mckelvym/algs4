...
/**
 * The <tt>FlowNetwork</tt> class represents a capacitated network with vertices
...
public class FlowNetwork
{
	...
	/**
	 * Initializes a random flow network with <tt>V</tt> vertices and <em>E</em>
	 * edges. The capacities are integers between 0 and 99 and the flow values
	 * are zero. param V the number of vertices param E the number of edges
	 * 
	 * @throws java.lang.IllegalArgumentException
	 *             if <tt>V</tt> < 0
	 * @throws java.lang.IllegalArgumentException
