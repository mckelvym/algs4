 ...
 * {@link SeparateChainingHashST}, <i>Algorithms, 4th Edition</i> by Robert
...
public class LinearProbingHashST<Key, Value>
{
	...
	public void delete(final Key key)
	{
		...
		while (keys[i] != null)
		{
			...
			final Value valToRehash = vals[i];
			keys[i] = null;
			vals[i] = null;
			N--;
	...
	{
		final LinearProbingHashST<Key, Value> temp = new LinearProbingHashST<Key, Value>(
				capacity);
		for (int i = 0; i < M; i++)
		{
			if (keys[i] != null)
