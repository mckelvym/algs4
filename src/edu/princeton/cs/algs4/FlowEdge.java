 ...
 * href="http://algs4.cs.princeton.edu/64maxflow">Section 6.4</a> of
...
public class FlowEdge
{
	...
	{
		final FlowEdge e = new FlowEdge(12, 23, 3.14);
		StdOut.println(e);
	}
	...
	/**
	 * Initializes an edge from vertex <tt>v</tt> to vertex <tt>w</tt> with the
	 * given <tt>capacity</tt> and zero flow.
	 * 
	 * @param v
	 *            the tail vertex
	 * @param w
	...
	/**
	 * Initializes an edge from vertex <tt>v</tt> to vertex <tt>w</tt> with the
	 * given <tt>capacity</tt> and <tt>flow</tt>.
	 * 
	 * @param v
	 *            the tail vertex
	 * @param w
	 ...
	 * <tt>vertex</tt> is the tail vertex, this increases the flow on the edge
	 * by <tt>delta</tt>; if <tt>vertex</tt> is the head vertex, this decreases
	 * the flow on the edge by <tt>delta</tt>.
	 * 
	 * @param vertex
	 *            one endpoint of the edge
	 * @throws java.lang.IllegalArgumentException
	 *             if <tt>vertex</tt> is not one of the endpoints of the edge
	 * @throws java.lang.IllegalArgumentException
	 ...
	 *         vertex If <tt>vertex</tt> is the tail vertex, the residual
	 *         capacity equals <tt>capacity() - flow()</tt>; if <tt>vertex</tt>
	 *         is the head vertex, the residual capacity equals <tt>flow()</tt>.
	 * @throws java.lang.IllegalArgumentException
	 *             if <tt>vertex</tt> is not one of the endpoints of the edge
	 */
