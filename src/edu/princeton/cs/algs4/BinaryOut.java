...
public final class BinaryOut
{
	...
	private int						n;		// number of bits remaining in
											// buffer
	 ...
	 *             unless <tt>x</tt> is betwen 0 and 255
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             unless <tt>r</tt> is between 1 and 16
	 * @throws IllegalArgumentException
	 *             unless <tt>x</tt> is between 0 and 2<sup>r</sup> - 1
	 */
	 ...
	 *            the number of relevant bits in the char
	 * @throws IllegalArgumentException
	 *             unless <tt>r</tt> is between 1 and 32
	 * @throws IllegalArgumentException
	 *             unless <tt>x</tt> is between 0 and 2<sup>r</sup> - 1
	 */
