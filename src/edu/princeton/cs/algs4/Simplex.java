...
public class Simplex
{
	...
	public static void main(final String[] args)
	{
		...
		final Simplex lp = new Simplex(A, b, c);
	...
	{
		final double[][] A = { { -1, 1, 0 }, { 1, 4, 0 }, { 2, 1, 0 },
				{ 3, -4, 0 }, { 0, 0, 1 }, };
		final double[] c = { 1, 1, 1 };
		final double[] b = { 5, 45, 27, 24, 4 };
		test(A, b, c);
	}
	...
	public static void test3()
	{
		...
		final double[][] A = { { -2.0, -9.0, 1.0, 9.0 },
				{ 1.0, 1.0, -1.0, -2.0 }, };
		test(A, b, c);
	}
	...
	public static void test4()
	{
		...
		final double[][] A = { { 0.5, -5.5, -2.5, 9.0 },
				{ 0.5, -1.5, -0.5, 1.0 }, { 1.0, 0.0, 0.0, 0.0 }, };
		test(A, b, c);
	}

	private final double[][]	a;		// tableaux

	private final int[]			basis;	// basis[i] = basic variable
	...
	public Simplex(final double[][] A, final double[] b, final double[] c)
	{
		M = b.length;
		N = c.length;
