 ...
 * rectangle is <em>closed</em>&mdash;it includes the points on the boundary.
 * <p>
...
public final class RectHV
{
	 ...
	 *             if any of <tt>xmin</tt>, <tt>xmax</tt>, <tt>ymin</tt>, or
	 *             <tt>ymax</tt> is <tt>Double.NaN</tt>.
	 * @throws IllegalArgumentException
	 *             if <tt>xmax</tt> &lt; <tt>xmin</tt> or <tt>ymax</tt> &lt;
	 *             <tt>ymin</tt>.
	 */
	public RectHV(final double xmin, final double ymin, final double xmax,
			final double ymax)
	{
	 ...
	 * @param p
	 *            the point
	 * @return the square of the Euclidean distance between the point <tt>p</tt>
	...
	public int hashCode()
	{
		final int hash1 = ((Double) xmin).hashCode();
		final int hash2 = ((Double) ymin).hashCode();
		final int hash3 = ((Double) xmax).hashCode();
		final int hash4 = ((Double) ymax).hashCode();
	 ...
	 * @param that
	 *            the other rectangle
	 * @return <tt>true</tt> if this rectangle intersect the argument rectagnle
	 *         at one or more points, including on the boundary
	 */
