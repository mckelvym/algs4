 ...
 * href="http://algs4.cs.princeton.edu/33balanced">Section 3.3</a> of
 * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne. For other
 * implementations, see {@link ST}, {@link BinarySearchST},
 * {@link SequentialSearchST}, {@link BST}, {@link SeparateChainingHashST}, and
...
public class RedBlackBST<Key extends Comparable<Key>, Value>
{
	...
	private class Node
	{
		...
		public Node(final Key key, final Value val, final boolean color,
				final int N)
		{
			this.key = key;
			this.val = val;
