...
public class PatriciaST<Value>
{
	...
	/**
	 * Unit tests the <code>PatriciaST</code> data type. This test fixture runs
	...
	/**
	 * Returns all keys in the symbol table as an <code>Iterable</code>. To
	 * iterate over all of the keys in the symbol table named <code>st</code>,
	 ...
	 * the value provided is <code>null</code>, then the key becomes removed
	 * from the symbol table.
	 * 
	 * @param key
	 *            the key
