 ...
 * implementations, see {@link PrimMST}, {@link KruskalMST}, and
 * {@link BoruvkaMST}.
 *
...
public class LazyPrimMST
{
	...
	private void prim(final EdgeWeightedGraph G, final int s)
	{
		...
		{ // better to stop when mst has V-1 edges
			final Edge e = pq.delMin(); // smallest edge on pq
			final int v = e.either(), w = e.other(v); // two endpoints
