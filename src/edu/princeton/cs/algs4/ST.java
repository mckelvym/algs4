...
public class ST<Key extends Comparable<Key>, Value> implements Iterable<Key>
{
	...
	/**
	 * Removes the key and associated value from this symbol table. (if the key
	 ...
	 *         symbol table; <tt>null</tt> if the key is not in the symbol table
	 * @throws NullPointerException
	 *             if <tt>key</tt> is <tt>null</tt>
	 */
	 ...
	 * keys in a symbol table named <tt>st</tt>, use the foreach notation:
