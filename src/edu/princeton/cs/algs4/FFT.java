...
/**
 * The <tt>FFT</tt> class provides methods for computing the FFT (Fast-Fourier
...
public class FFT
{
	 ...
	 *             if the length of <t>x</tt> does not equal the length of
	 ...
	 * @throws IllegalArgumentException
	 *             if the length of <t>x</tt> is not a power of 2
	 */
