 ...
 * href="http://algs4.cs.princeton.edu/64maxflow">Section 6.4</a> <i>Algorithms,
...
public class FordFulkerson
{
	...
	private boolean hasAugmentingPath(final FlowNetwork G, final int s,
			final int t)
	{
	 ...
	 * 
	 * @return <tt>true</tt> if vertex <tt>v</tt> is on the <tt>s</tt> side of
	 *         the micut, and <tt>false</tt> if vertex <tt>v</tt> is on the
	 *         <tt>t</tt> side.
	 * @throws IndexOutOfBoundsException
	 *             unless 0 <= v < V
	 */
	...
	private void validate(final int v, final int V)
	{
		if (v < 0 || v >= V)
		{
