		...
		MouseMotionListener, KeyListener
{
	 ...
	 */
	public static final Color				BOOK_BLUE			= new Color(9,
																		90, 166);
	 ...
	 */
	public static final Color				BOOK_LIGHT_BLUE		= new Color(
																		103,
																		198,
																		243);
	 ...
	 */
	public static final Color				BOOK_RED			= new Color(
																		150,
																		35, 31);
	 ...
	 * (such as <tt>'a'</tt> or <tt>'A'</tt>). It cannot identify action keys
	...
	public static void save(final String filename)
	{
		...
		else if (suffix.toLowerCase().equals("jpg"))
		{
			...
			newRaster = raster.createWritableChild(0, 0, width, height, 0, 0,
					new int[] { 0, 1, 2 });
			final DirectColorModel cm = (DirectColorModel) onscreenImage
					.getColorModel();
	...
	/**
	 * Sets the window size to the default size 512-by-512 pixels. This method
	...
	/**
	 * Sets the window size to <tt>w</tt>-by-<tt>h</tt> pixels. This method must
	 ...
	 *             range
	 */
	public static void setPenColor(final int red, final int green,
			final int blue)
	{
		if (red < 0 || red >= 256)
		{
	...
	public static void setPenRadius(final double r)
	{
		...
		penRadius = r;
		final float scaledPenRadius = (float) (r * DEFAULT_SIZE);
		final BasicStroke stroke = new BasicStroke(scaledPenRadius,
	...
	{
		final FileDialog chooser = new FileDialog(StdDraw.frame,
