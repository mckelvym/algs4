...
public final class In
{
	...
	/**
	 * Returns true if this input stream is empty (including whitespace). Use
	 * this to know whether the next call to {@link #readChar()} will succeed.
	 * <p>
	 * Functionally equivalent to {@link #hasNextLine()}.
	 *
	 * @return <tt>true</tt> if this input stream is empty (including
	...
	/**
	 * Returns true if this input stream has a next line. Use this to know
	 * whether the next call to {@link #readLine()} will succeed.
	 * <p>
