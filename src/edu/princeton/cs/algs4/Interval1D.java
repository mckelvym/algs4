...
/**
 * The <tt>Interval1D</tt> class represents a one-dimensional interval. The
 * interval is <em>closed</em>&mdash;it contains both endpoints. Intervals are
 * immutable: their values cannot be changed after they are created. The class
 * <code>Interval1D</code> includes methods for checking whether an interval
...
public class Interval1D
{
	 ...
	 * @throws IllegalArgumentException
	 *             if either <tt>left</tt> or <tt>right</tt> is
	...
	public int hashCode()
	{
		final int hash1 = ((Double) left).hashCode();
		final int hash2 = ((Double) right).hashCode();
	 ...
	 *
	 * @return a string representation of this interval in the form [left,
	 *         right]
	 */
	@Override
