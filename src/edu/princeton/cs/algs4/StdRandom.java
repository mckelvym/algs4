...
public final class StdRandom
{
	 ...
	 *         probability <tt>a[i]</tt>
	 * @throws IllegalArgumentException
	 *             if sum of array entries is not (very nearly) equal to
	 *             <tt>1.0</tt>
	 * @throws IllegalArgumentException
	 *             unless <tt>a[i] >= 0.0</tt> for each index <tt>i</tt>
	 */
	...
	/**
	 * Returns a random real number from an exponential distribution with a
	 * given rate.
	 * 
	 * @param lambda
	...
	/**
	 * Returns a random real number from a Pareto distribution with a given
	 * shape parameter.
	 *
	 * @param alpha
	 *            shape parameter
	...
	/**
	 * Rearranges the elements of a <tt>double</tt> array in uniformly random
	 * order.
	 *
	 * @param a
	...
	/**
	 * Rearranges the elements of an <tt>int</tt> array in uniformly random
	 * order.
	 *
	 * @param a
	 *            the array to shuffle
