...
public class DepthFirstOrder
{
	...
	private final boolean[]			marked;		// marked[v] = has v been
													// marked in dfs?
	private final int[]				post;			// post[v] = postorder
													// number of v
	private int						postCounter;	// counter for postorder
													// numbering
	private final Queue<Integer>	postorder;		// vertices in postorder
	private final int[]				pre;			// pre[v] = preorder number
													// of v
	private int						preCounter;	// counter or preorder
													// numbering
