 ...
 * <p/>
 * In <tt>Fenwick Tree</tt> structure We arrange the array in an smart way to
...
public class FenwickTree
{
	 ...
	 * with value v. exit
	 * <p/>
	 * The array is 1-indexed Example: <<set 1 2 3 4 5 6 <<rsq 1 3 >>Sum from 1
	 * to 3 = 6 <<rmq 1 3 >>Min from 1 to 3 = 1 <<input up 1 3 >>[3,2,3,4,5,6]
	 *
	 * @param args
	 */
